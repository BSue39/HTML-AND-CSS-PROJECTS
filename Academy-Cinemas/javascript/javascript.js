...
popoverTriggerList.forEach(function (element) {
    var ingSrc = element.getAttribute('data-bs-img');
...
$(document).ready(function () {
    //On click when an element contains just the nav-link class and not the
    // dropdown-toggle and then also close when and element with the class .dropdown-iten
